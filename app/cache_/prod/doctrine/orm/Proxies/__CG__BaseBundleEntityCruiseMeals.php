 ...
 */
class CruiseMeals extends \BaseBundle\Entity\CruiseMeals implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BaseBundle\\Entity\\CruiseMeals' . "\0" . 'id', '' . "\0" . 'BaseBundle\\Entity\\CruiseMeals' . "\0" . 'name', 'prices'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CruiseMeals $proxy) {
