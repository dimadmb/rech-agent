 ...
 */
class CruiseShipDeck extends \BaseBundle\Entity\CruiseShipDeck implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BaseBundle\\Entity\\CruiseShipDeck' . "\0" . 'id', '' . "\0" . 'BaseBundle\\Entity\\CruiseShipDeck' . "\0" . 'name', '' . "\0" . 'BaseBundle\\Entity\\CruiseShipDeck' . "\0" . 'deckId', '' . "\0" . 'BaseBundle\\Entity\\CruiseShipDeck' . "\0" . 'cabins'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CruiseShipDeck $proxy) {
