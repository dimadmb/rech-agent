 ...
 */
class Photo extends \BaseBundle\Entity\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BaseBundle\\Entity\\Photo' . "\0" . 'id', '' . "\0" . 'BaseBundle\\Entity\\Photo' . "\0" . 'title', '' . "\0" . 'BaseBundle\\Entity\\Photo' . "\0" . 'description', '' . "\0" . 'BaseBundle\\Entity\\Photo' . "\0" . 'filename', '' . "\0" . 'BaseBundle\\Entity\\Photo' . "\0" . 'url', '' . "\0" . 'BaseBundle\\Entity\\Photo' . "\0" . 'preview', '' . "\0" . 'BaseBundle\\Entity\\Photo' . "\0" . 'document'];
        }
