...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BaseBundle:Document')->findAll();
     ...
     * @Method("POST")
     * @Template("BaseBundle:Document:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BaseBundle:Document')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BaseBundle:Document:edit.html.twig")
     */
